  ...
  PostFluent<Post> findUniqueOrThrow({required PostWhereUniqueInput where}) {
    ...
    final future = query(PostScalarFieldEnum.values.toGraphQLFields()).then(
        (json) => json is Map
            ...
            : throw Exception('Not found TypeRefType.string(value: Post)'));
    return PostFluent<Post>(
      future,
      query,
    );
...
class PrismaClient extends _i1.BasePrismaClient<PrismaClient> {
  ...
  factory PrismaClient({
    ...
    final engine = _i5.BinaryEngine(
      logger: logger,
      schema:
          r'',
      datasources: datasources?.toJson().cast() ?? const {},
      executable:
          r'/Users/efthymis/workspaces/fluttercon/dor_blog/node_modules/prisma/query-engine-darwin-arm64',
    );
